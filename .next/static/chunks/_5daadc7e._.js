(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_5daadc7e._.js", {
...
"[project]/node_modules/react-orbit-component/dist/index.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var OrbitPath = ({ className, children, type, style })=>{
    ...
    const [newChildren, setNewChildren] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const size = useWindowSize();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrbitPath.useEffect2": ()=>{
            ...
            const updatedChildren = childrenArray.map({
                "OrbitPath.useEffect2.updatedChildren": (child, index)=>{
                    const childElement = child;
                    const newProps = __spreadProps(__spreadValues({}, childElement.props), {
                        radius
                    });
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].cloneElement(childElement, __spreadProps(__spreadValues({}, newProps), {
                        key: index
                    }));
                }
            }["OrbitPath.useEffect2.updatedChildren"]);
...
var OrbitItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])((_a, ref)=>{
    ...
    var _a2, _b2;
    const [angleState, setAngle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(startAngle);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrbitItem.useEffect3": ()=>{
            const interval = setInterval({
                "OrbitItem.useEffect3.interval": ()=>{
                    setAngle({
                        "OrbitItem.useEffect3.interval": (prevAngle)=>direction === "clockwise" ? prevAngle + anglePerStep % 360 : prevAngle - anglePerStep % 360
                    }["OrbitItem.useEffect3.interval"]);
                }
            }["OrbitItem.useEffect3.interval"], timeBetweenSteps);
            return ({
                "OrbitItem.useEffect3": ()=>clearInterval(interval)
            })["OrbitItem.useEffect3"];
        }
    }["OrbitItem.useEffect3"], [
        anglePerStep,
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("div", __spreadValues({
...
//# sourceMappingURL=_5daadc7e._.js.map